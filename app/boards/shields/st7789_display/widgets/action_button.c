...
void print_frames() {
    ...
    for (uint16_t y = 14; y <= 26; y += 3) {
        ...
        print_filled_screen_area(40, y, 37, 2, gray);
        print_filled_screen_area(162, y, 66, 2, gray);
    }
    print_filled_screen_area(78, 12, 82, 18, white);

    /* Reuse the same complete 7 x 9 font as the layer name, at its native resolution. */
    print_layer_font_text(title_font_buf, "KEYPOINT", 8, 80, 16, 1, black, white);
