...
#define SPEED_DOWN_POSITION 49
#define SPEED_UP_POSITION 50
#define LOWER_LEFT_POSITION 61
#define LOWER_RIGHT_POSITION 62
...
static void poll_handler(struct k_work *work) {
    ...
    if (brt != last_brt) {
        ...
        bool speed_adjusted = speed_adjust_pending &&
            (k_uptime_get_32() - last_speed_adjust_time <= SPEED_ADJUST_WINDOW_MS);
