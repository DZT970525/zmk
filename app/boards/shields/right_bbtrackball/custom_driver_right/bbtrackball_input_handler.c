...
/* ==== GPIO Pins ==== */
#define DOWN_GPIO_PIN 7   // gpio0 7
#define LEFT_GPIO_PIN 8   // gpio1 8
#define UP_GPIO_PIN 14    // gpio0 14
#define RIGHT_GPIO_PIN 11 // gpio0 11
...
static DirInput dir_inputs[] = {
    {DEVICE_DT_GET(GPIO1_DEV), LEFT_GPIO_PIN, 1, 0, -1},
